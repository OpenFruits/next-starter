    ...
    return clsx(
      "grid place-items-center focus-visible:ring-2 transition duration-200 ease-in-out focus:outline-none",
      {
        ...
        "text-white bg-red-500 hover:bg-red-600 focus-visible:bg-red-600 focus-visible:ring-red-400":
          variant === "solid-red",
        "bg-gray-100 hover:bg-gray-200 focus-visible:bg-gray-200 focus-visible:ring-blue-400": variant === "solid-gray",
        "bg-white hover:bg-gray-100 focus:bg-gray-100": variant === "solid-white",
        "text-white bg-black hover:bg-gray-800 focus:bg-gray-800 ": variant === "solid-black",
      },
      className
    );
  }, [className, variant]);
